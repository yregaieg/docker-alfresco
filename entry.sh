...
if [ ! -f /opt/alfresco/alf_data/foo.txt ]; then
    cp -Rp /opt/alfresco/alf_data_back/* /opt/alfresco/alf_data;bash /tunerepo.sh;/modifinitpass.sh;/opt/alfresco/alfresco.sh start;/waitready.sh;/opt/alfresco/alfresco.sh stop;/tunesolr.sh;touch /opt/alfresco/alf_data/foo.txt
fi
